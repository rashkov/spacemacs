...
By default, refmt will wrap text longer than 80 characters. To specify a custom value (100 in this example), add the following to your =dotspacemacs-user-config=:
